...
struct ProcessMediaView: View {
  private let onComplete: (PredictionSessionModel) -> Void
  ...
  @EnvironmentObject private var viewModel: ProcessMediaViewModel
    ...
    NavigationView {
      List {
        ...
        if viewModel.groupConfigMessage == nil {
          ...
          .pickerStyle(.menu)
          .disabled(viewModel.processingState != .idle)
        }
        ...
        ToolbarItem(placement: .topBarTrailing) {
          Button {
            ...
            Image(systemName: "xmark")
              ...
              .foregroundStyle(viewModel.processingState == .processing ? Color.EcoSort.Base.border : Color.EcoSort.Text.text5)
          }
...
//    }
  ...
  init(
    onComplete: @escaping (PredictionSessionModel) -> Void,
